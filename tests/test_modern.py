...
from rothc_py.utils import modern_c, DECAY_LAMBDA


class TestModernC:
    """Tests for the modern_c function."""

    def test_pre_1939_returns_all_100(self):
        """Starting before 1939 should return 100% for all months."""
        result = modern_c(datetime(1860, 1, 1), 12)
    ...
    def test_pre_1939_then_1939_data(self):
        ...
        result = modern_c(datetime(1938, 1, 1), 24)
    ...
    def test_within_data_range_1990(self):
        ...
        result = modern_c(datetime(1990, 1, 1), 12)
    ...
    def test_within_data_range_2000(self):
        ...
        result = modern_c(datetime(2000, 1, 1), 12)
    ...
    def test_bomb_peak_1963_1964(self):
        ...
        result = modern_c(datetime(1963, 1, 1), 24)
    ...
    def test_extrapolation_starts_from_2007_12(self):
        ...
        result = modern_c(datetime(2007, 12, 1), 3)
    ...
    def test_extrapolation_decay(self):
        ...
        result = modern_c(datetime(2008, 1, 1), 36)
    ...
    def test_extrapolation_approaches_100(self):
        ...
        result = modern_c(datetime(2020, 1, 1), 120)  # 10 years
...
class TestDecayLambda:
    ...
    def test_exponential_decay_formula(self):
        ...
        result = modern_c(datetime(2007, 12, 1), 13)
